...
namespace hydrolib::controlling
{
    ...
    {
    public:
        PID(unsigned last_output = 0, unsigned last_input = 0) : p_(0),
                                                                 i_(0),
                                                                 divide_shift_(0),
                                                                 current_input_(0),
    ...
    public:
        ...
        void SetDivideShift(unsigned divide_shift)
        {
            divide_shift_ = divide_shift;
        }
        ...
        int Process(int input)
        {
            ...
            int delta = p_ * (current_input_ - last_input_) +
                        i_ / FREQ_HZ / 2 * (current_input_ + last_input_);
