...
{
    Vector3D<FixedPoint10> vec{FixedPoint10(1), FixedPoint10(2),
                               FixedPoint10(3)};
...
TEST(TestHydrolibMathVector3D, LengthCalculation)
{
    ...
    FixedPoint10 length = vec.Length();
...
{
    Vector3D<FixedPoint10> vec{1.0_fp, 2.0_fp, 2.0_fp};
...
TEST(TestHydrolibMathVector3D, ScalarMultiplicationRight)
{
    ...
    FixedPoint10 scalar(2);

    Vector3D<FixedPoint10> result = vec * scalar;
...
{
    Vector3D<FixedPoint10> vec{2.0_fp, 4.0_fp, 6.0_fp};
    FixedPoint10 scalar(0.5);
...
{
    Vector3D<FixedPoint10> vec{5.0_fp, 10.0_fp, 15.0_fp};
    FixedPoint10 zero(0);

    Vector3D<FixedPoint10> result = vec * zero;
...
{
    Vector3D<FixedPoint10> vec{6.0_fp, 8.0_fp, 10.0_fp};
    FixedPoint10 divisor(2);

    Vector3D<FixedPoint10> result = vec / divisor;
...
{
    Vector3D<FixedPoint10> vec{9.0_fp, 12.0_fp, 15.0_fp};
    FixedPoint10 divisor(3);
...
{
    Vector3D<FixedPoint10> vec{1.0_fp, 2.0_fp, 3.0_fp};
    FixedPoint10 scalar1(2);
    FixedPoint10 scalar2(3);

    Vector3D<FixedPoint10> result = (vec * scalar1) * scalar2;
...
{
    Vector3D<FixedPoint10> original{2.5_fp, 5.0_fp, 7.5_fp};
    FixedPoint10 scalar(4);

    Vector3D<FixedPoint10> multiplied = original * scalar;
    Vector3D<FixedPoint10> result = multiplied / scalar;
