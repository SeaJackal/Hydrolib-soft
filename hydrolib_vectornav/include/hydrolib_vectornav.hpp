...
#pragma pack(pop)
 ...
 public:
  ...
  ReturnCode Write(const void *buffer, uint32_t address, uint32_t length);
...
template <concepts::stream::ByteFullStreamConcept InputStream, typename Logger>
ReturnCode VectorNAVParser<InputStream, Logger>::Write(
    [[maybe_unused]] const void *buffer, [[maybe_unused]] uint32_t address,
