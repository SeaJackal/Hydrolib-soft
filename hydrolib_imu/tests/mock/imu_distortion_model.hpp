...
class IMUDistorter {
 public:
  IMUDistorter(math::Quaternion<Number> rotation, math::Vector3D<Number> error);
...
template <math::ArithmeticConcept Number>
math::Vector3D<Number> IMUDistorter<Number>::DistortAccel(
    math::Vector3D<Number> accel) {
