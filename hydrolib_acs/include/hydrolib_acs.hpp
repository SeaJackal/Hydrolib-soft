...
void ControlSystem<IMUModel, PressureModel, Thrusters, FREQ_HZ>::Process() {
  ...
  int roll_epsilon =
      roll_control_mdeg_ - imu_data.roll_mdeg * closing_contours_.roll_circuit;
  int depth_epsilon = depth_control_mm_ -
                      pressure_data.depth_mm * closing_contours_.depth_circuit;
