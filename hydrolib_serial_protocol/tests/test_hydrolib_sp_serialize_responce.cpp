...
namespace test_core
{
TEST_P(TestHydrolibSerialProtocolSerializeParametrized, ResponceTest)
{
    auto param = GetParam();
    uint8_t mem_address = std::get<0>(param);
    uint8_t data_length = std::get<1>(param);
...
TEST_P(TestHydrolibSerialProtocolSerializeParametrized, ResponceWithNoizeTest)
{
    auto param = GetParam();
    uint8_t mem_address = std::get<0>(param);
    uint8_t data_length = std::get<1>(param);
